    ...
    <section class="content">
     ...
     <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Buat Message Baru</h3>
            ...
            <!-- /.box-header -->
            <form id="postmessage" action="" method="post" >
            <form role="form">
            <div class="box-body">
              <div class="row">
               <div class="col-md-12">
                  ...
                  <label>Message</label>
                  <textarea name="berita" class="form-control" rows="3" placeholder="Message ..."></textarea>
                </div> 
      ...
      <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Timeline Message</h3>
...
<script>
  ...
  function myajax(id,data1,url,fbefore=null,fafter=null) {
    ...
    function after(data)
    {
       window.location.href = "<?php echo site_url('Wisudawan_dashboard/message'); ?>";
    }
  ...
  $(function () {
   $("#postmessage").submit(function(e) {
        ...
        e.preventDefault();
            ...
            myajax('',data,'<?php echo base_url();?>index.php/Wisudawan_dashboard/addmessage',null,after);    
